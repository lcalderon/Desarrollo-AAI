...
return false;}
if(this.config.tab2tab&&false!=this.config.tab2tab){this.config.tab2tab=false;}
...
if(this.config.index<0){this.config.index=-1;}};Zapatec.Tab.tabIndex=0;Zapatec.Tab.prototype.getFocusOn=function(){this.focusOn=null;if(this.tab2tab){return;}
