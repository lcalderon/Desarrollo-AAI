...
if ($_GET[idubigeo]!=''){
		...
		$ubigeo= new ubigeo();
		$ubigeo->leer($_GET[idubigeo]);
		$campo_act = $_GET[campo];
...
<table>
	...
	<tr>
		<td><?=_('Nro')?></td>
		<td>
		<input type="text" name="NUMERO" size="12" maxlength="12" id='numero' autocomplete="off"  onkeypress="return validarnum(event)" >
	...
	<tr>
		...
		<td><textarea name='DESCRIPCION' value='' cols='40' rows="1" id='descripcion' ></textarea></td>
	</tr>
</table>
</fieldset>
