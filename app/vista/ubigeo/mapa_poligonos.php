...
$arrambito =$_GET[arrambito];

// leer datos del el poligono
...
<div>
<form id='form_prov_serv_poli' name='form_prov_serv_poli' >
	...
	<input type ='button' value='Grabar' onclick="grabar_mapa();"></input>
</form>
</div>
...
var idpoligono = '<?=$poligono->idpoligono?>';
...
function grabar_mapa(idpoligono)
{
	...
	else
	{
		...
		{
			new Ajax.Request('../../controlador/ajax/ajax_poligono.php?opcion=grabar',
			{
				method : 'post',
				parameters: {
					IDPOLIGONO:'<?=$poligono->idpoligono?>',
