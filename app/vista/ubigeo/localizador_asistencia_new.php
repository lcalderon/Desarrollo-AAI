...
<table>
	...
	<tr>
		...
		<input type ='button' value="<?=_('Ajustes de ubicacion') ?>" class="normal" id="ver_mapa" onclick='geolocalizacion();'></input>
...
function geolocalizacion(){
	...
	var cveentidad1 = $F('cveentidad1');
	var cveentidad2 = $F('cveentidad2');
	var direccion = $F('direccion');
	var lat= $F('latitud');
	var lng= $F('longitud');
	
	window.open("mapas/geolocalizacion.php?lat="+lat+"&lng="+lng+"&cveentidad1="+cveentidad1+"&cveentidad2="+cveentidad2+"&direccion="+direccion,
			'_blank',
