...
<tr>
	...
	DESCRIPCION
	";
	$con->cmbselect_db('CVEENTIDAD1',$sql,$entfed1_default,'id="cveentidad1" class="classtexto" onfocus="coloronFocus(this);" onBlur="colorOffFocus(this);"','','TODOS' );
	?>
	</td>
</tr>
	<?}?>
...
<tr >
	...
	DESCRIPCION
	";
	$con->cmbselect_db('CVEENTIDAD2',$sql,$entfed2_default,'id="cveentidad2" class="classtexto" onfocus="coloronFocus(this);" onBlur="colorOffFocus(this);"','','TODOS' );
	?>
	</td>
</tr>
	<?}?>
...
<tr >
	...
	DESCRIPCION
	";
	$con->cmbselect_db('CVEENTIDAD3',$sql,$entfed3_default,'id="cveentidad3" class="classtexto" onfocus="coloronFocus(this);" onBlur="colorOffFocus(this);"','','TODOS' );
	?>
	</td>
</tr>
	<?}?>
...
<tr >
	...
	DESCRIPCION
	";
	$con->cmbselect_db('CVEENTIDAD4',$sql,$entfed4_default,'id="cveentidad4" class="classtexto" onfocus="coloronFocus(this);" onBlur="colorOffFocus(this);"','','TODOS' );
	?>
	</td>
</tr>
	<?}?>	
...
<tr >
	...
	DESCRIPCION
	";
	$con->cmbselect_db('CVEENTIDAD5',$sql,$entfed4_default,'id="cveentidad5" class="classtexto" onfocus="coloronFocus(this);" onBlur="colorOffFocus(this);"','','TODOS' );
	?>
	</td>
</tr>
	<?}?>
...
<tr >
	...
	DESCRIPCION
	";
	$con->cmbselect_db('CVEENTIDAD6',$sql,$entfed5_default,'id="cveentidad6" class="classtexto" onfocus="coloronFocus(this);" onBlur="colorOffFocus(this);"','','TODOS' );
	?>
	</td>
</tr>
	<?}?>
...
<tr >
	...
	DESCRIPCION
	";
	$con->cmbselect_db('CVEENTIDAD7',$sql,$entfed6_default,'id="cveentidad7" class="classtexto" onfocus="coloronFocus(this);" onBlur="colorOffFocus(this);"','','TODOS' );
	?>
	</td>
</tr>
	<?}?>
...
new Event.observe('cveentidad1','change',function (){
	new Ajax.Updater('cveentidad2',"../../controlador/ajax/ajax_entfed2.php",
	{	insertion: Insertion.Blank,
	method: 'post',
	parameters: { ent1: $F('cveentidad1') }
	}
	);
	new Ajax.Updater('cveentidad3',"../../controlador/ajax/ajax_entfed3.php",
	{	insertion: Insertion.Blank}
	);
	new Ajax.Updater('cveentidad4',"../../controlador/ajax/ajax_entfed4.php",
	{	insertion: Insertion.Blank}
	);
	new Ajax.Updater('cveentidad5',"../../controlador/ajax/ajax_entfed5.php",
	{	insertion: Insertion.Blank}
	);
	new Ajax.Updater('cveentidad6',"../../controlador/ajax/ajax_entfed6.php",
	{	insertion: Insertion.Blank}
	);
	new Ajax.Updater('cveentidad7',"../../controlador/ajax/ajax_entfed7.php",
	{	insertion: Insertion.Blank}
	);
});
