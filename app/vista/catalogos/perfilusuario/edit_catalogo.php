...
<form name="frmeditregistro" action="actualizar_plantilla.php" method="POST" onSubmit = "return validarCampo(this)" >
  <table border="0" cellpadding="1" cellspacing="1" width="70%" class="catalogos">
    ...
    <tr class='modo1'>
      <td align="right"><input name="Submit"  class="botonstandar" type="submit" value="<?=_('GRABAR') ;?>" title="<?=_('GRABAR PLANTILLA') ;?>" ></td>
      <td><input  type="button" class="botonstandar" value="<?=_('REGRESAR') ;?>" onClick="reDirigir('general.php')" title="<?=_('REGRESAR') ;?>"></td>	  
    </tr>
	<tr class='modo1'>
	  <td colspan="2"><div align="right"><em><strong><a href="#" onClick="new parent.MochaUI.Window({id: 'containertest',title: '<?=_("ACCESOS AL SISTEMA");?>',loadMethod: 'iframe',contentURL: '../../../../app/vista/catalogos/perfilusuario/frmaccesos.php?idperfil=<?=$_GET["codigo"]; ?>',container: 'pageWrapper',width: 960,height: 450,x: 250,y:50});"><?=_('A&Ntilde;ADIR ACCESOS') ;?>
	  </a></strong></em></div></td>
	</tr>
  </table>           
