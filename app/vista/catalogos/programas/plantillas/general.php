<?php
	...
	$sql="SELECT IDPLANTILLAPERFIL,NOMBRE,if(ACTIVO=1,'ACTIVO','INACTIVO') FROM catalogo_plantillaperfil where NOMBRE like '%".$_POST["busqueda"]."%'";
...
<html>
	...
	<label>
		...
		<div id="resultado">	
	<h2><font size='3px'><?=_("CATALOGO DE PLANTILLAS") ;?></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size='2px' color="#FF6666"><input type="radio" name="radio" id="radio" onClick="reDirigir('../usuarios/general.php')" value="0" title="<?=_("CATALOGO DE USUARIOS") ;?>">Usuarios&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="radio" id="radio" value="1" checked title="<?=_("CATALOGO DE PLANILLAS") ;?>">Plantillas</font> </h2>
