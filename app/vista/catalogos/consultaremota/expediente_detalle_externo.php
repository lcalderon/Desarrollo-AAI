...
<body >
   ...
   <tr>
        ...
        <td><input name="txttelefono[]" type="text" readonly class="classtexto" id="txttelefono[]" style="text-transform:uppercase;" onFocus="coloronFocus(this);" onBlur="colorOffFocus(this);" size="15" maxlength="17" value="<?=$telefono[1];?>" /><?
