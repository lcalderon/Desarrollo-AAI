	...
	<h2 class="Box"><?=_("GESTION DEL AFILIADO") ;?></h2>
		...
		<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#c4c4c4" style="border:2px solid #9fd1ff">
			...
			<tr>
				...
				<td><?=_("TELEFONO2");?></td>
				<td><input name="txttelefono[]" type="text" class="classtexto" id="txttelefono" <?=($_GET["verinfo"])?$readonly:"" ;?> style="text-transform:uppercase;" onFocus="coloronFocus(this);" onBlur="colorOffFocus(this);" size="15" maxlength="17" value="<?=$numeroTelefono[1];?>"/><? if($numeroTelefono[2]!=""){?><img src="../../../../imagenes/iconos/telefono.jpg" align="absbottom"  border="0" style="cursor:pointer" onClick="llamada('<?=$codigoArea[1];?>','<?=$numeroTelefono[1];?>')" title="Llamar" /><? }?></td>
				<td><?=_("TELEFONO3");?></td>
				<td><input name="txttelefono[]" type="text" class="classtexto" id="txttelefono"  <?=($_GET["verinfo"])?$readonly:"" ;?> style="text-transform:uppercase;" onFocus="coloronFocus(this);" onBlur="colorOffFocus(this);" size="15" maxlength="17" value="<?=$numeroTelefono[2];?>" /><? if($numeroTelefono[3]!=""){?><img src="../../../../imagenes/iconos/telefono.jpg" align="absbottom"  border="0" style="cursor:pointer" onClick="llamada('<?=$codigoArea[2];?>','<?=$numeroTelefono[2];?>')" title="Llamar" /><? }?></td>
				<td><?=_("TELEFONO4");?></td>
