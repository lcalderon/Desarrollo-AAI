...
// Afliados en riesgos
	...
	$celdas=2;
	if($_POST["ckbplan"] || $_POST["ckbidplan"]){	
		if($_POST["ckbidplan"] and $_POST["ckbplan"])	$celdas=$celdas+2; else $celdas=$celdas+1;
		$agrupaplan="2,"; 
	}
	...
	if($_POST["ckbcanal"])	$agrupacanal="12,";
	if($_POST["ckbsucursal"])	$agrupasucursal="13,";
	if($_POST["ckbmodalidadpg"])	$agrupacondicionpg=",10";
	...
	if($_POST["btnconsultar"] or $_POST["btnexportar"]){
		...
		if($_POST["ckbidplan"]) $marcadoidplan="checked"; else $marcadoidplan="";
		...
		if($_POST["ckbsucursal"]){
			$marcadosucursal="checked";
			$sqlSucursal="LEFT JOIN $con->catalogo.catalogo_sucursal ON catalogo_sucursal.IDSUCURSAL = catalogo_afiliado.IDSUCURSAL";
			$campoSucursal=",catalogo_sucursal.DESCRIPCION AS SUCURSALS";
		} else{
	...
	$Sql_Afliadoriesgo=$Sql_Afliadoriesgo." GROUP BY 1,$agrupaplan $agrupacanal $agrupasucursal 3 $agrupacancelados $agrupacondicionpg ORDER BY catalogo_cuenta.NOMBRE,catalogo_programa.NOMBRE";
	...
	<li>
		...
		<div class="acc-section">
			...
			<table border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#F5F5F5" style="border:1px solid #DBDBDB;width:100%">
					...
					<td colspan="3" align="center"> <div align="center">
						<table align="center" border="1" cellpadding="1" cellspacing="1" bgcolor="#E1FFE1" style="border-collapse:collapse">
							<tr>
								...
								<td width="18%"><div align="right"><?=_("IDPLAN") ;?></div></td>
								<td width="5%"><input name="ckbidplan" type="checkbox" id="ckbidplan" <?=$marcadoidplan?>/></td>								
							...
							<tr>
								...
								<td colspan="5"><div align="right"><?=_("MODALIDADPG") ;?></div></td>
				...
				<tr>
					<td colspan="3" align="right"><div align="center"><input type="submit" name="btnconsultar" id="btnconsultar" value="CONSULTAR >>>" style="text-align:center;font-weight:bold;font-size:10px"/></div></td>
				</tr>
			</table>		
		</form>
			...
			<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" style="border:1px solid #C5C5E2;width:100%">
				<tr bgcolor="#9393ca">
					<td bgcolor="#9393ca"><div align="center"><strong><?=_("IDCUENTA") ;?></strong></div></td>  
					<td bgcolor="#9393ca"><div align="center"><strong><?=_("CUENTA") ;?></strong></div></td>
				  <? if($_POST["ckbidplan"]){ ?><td bgcolor="#9393ca"><div align="center"><strong><?=_("IDPLAN") ;?></strong></div></td><?}?>
				  <? if($_POST["ckbplan"]){ ?><td bgcolor="#9393ca"><div align="center"><strong><?=_("PLAN") ;?></strong></div></td><?}?>
				  <? if($_POST["ckbcanal"]){ ?><td bgcolor="#9393ca"><div align="center"><strong><?=_("CANAL") ;?></strong></div></td><?}?>
				  <? if($_POST["ckbsucursal"]){ ?><td bgcolor="#9393ca"><div align="center"><strong><?=_("SUCURSAL") ;?></strong></div></td><?}?>
					<td bgcolor="#9393ca"><div align="center"><strong><?=_("ACTIVOS") ;?></strong></div></div></td>
				  <? if($_POST["ckbcancelados"]){ ?><td bgcolor="#9393ca"><div align="center"><strong><?=_("CANCELADOS") ;?></strong></div></td><?}?>
				  <? if($_POST["ckbmodalidadpg"]){ ?><td bgcolor="#9393ca"><div align="center"><strong><?=_("MODALIDAD-PG") ;?></strong></div></td><?}?>
				  <? if($_POST["ckbtotal"]){ ?><td bgcolor="#9393ca"><div align="center"><strong><?=_("TOTALES") ;?></strong></div></td><?}?>
				</tr>
				<?
				...
				<tr bgcolor="<?=$fondo;?>">
					...
					<td><?=$reg->cuenta;?></td>
				  <? if($_POST["ckbidplan"]){ ?><td align="center"><?=$reg->IDPROGRAMA;?></td><?}?>
