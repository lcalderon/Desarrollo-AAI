<table border="0" cellpadding="1" cellspacing="1">
      <tr>
        ...
        <td><input name="txttelefono<?=$nombreobj;?>[]" type="text" class="classtexto" id="txttelefono<?=$nombreobj;?>"  <?=($_GET["verinfo"])?$readonly:"" ;?> style="text-transform:uppercase;" onFocus="coloronFocus(this);" onBlur="colorOffFocus(this);" size="15" maxlength="17" value="<?=$telefono[3];?>" /><?
			$sql="select IDTIPOTELEFONO,DESCRIPCION from catalogo_tipotelefono order by DESCRIPCION";
      ...
      <tr>
        ...
        <td colspan="8"><div  id='telefono2<?=$nombreobj;?>' style="display: none">
            <table width="200" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFE7D1" style="border:1px dashed #FF8080">
              <tr>
                <td width="156"><span class="style6">
                  <?=_("COD.AREA") ;?>
      ...
      <tr>
        ...
        <td colspan="8"><div  id='telefono4<?=$nombreobj;?>' style="display:none">
            <table width="200" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFE7D1" style="border:1px dashed #FF8080">
              <tr>
                <td width="156"><span class="style6">
                  <?=_("COD.AREA") ;?>
