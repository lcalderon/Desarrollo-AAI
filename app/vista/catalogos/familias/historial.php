...
//consulta sociedad log
	$result=$con->query("SELECT FECHAMOD,DESCRIPCION,COLOR,if(ACTIVO=1,'ACTIVO','INACTIVO') as statusf FROM $con->catalogo.catalogo_familia_log WHERE IDFAMILIA='".$_GET["idfamilia"]."' ORDER BY FECHAMOD DESC  ");
?>
<HTML>
	<head>
