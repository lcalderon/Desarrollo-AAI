...
$con = new DB_mysqli();
if (isset($prov->cveentidad1)){
$n_ent= $con->lee_parametro('UBIGEO_NIVELES_ENTIDADES');    // para Perú 3 niveles (DEPARTAMENTO/PROVINCIA/DISTRITO)
$idpais =$prov->cvepais;
$entfed1_default=$prov->cveentidad1;
$entfed2_default=$prov->cveentidad2;
$entfed3_default=$prov->cveentidad3;
$entfed4_default=$prov->cveentidad4;
$entfed5_default=$prov->cveentidad5;
$entfed6_default=$prov->cveentidad6;
$entfed7_default=$prov->cveentidad7;
