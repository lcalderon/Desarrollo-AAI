...
//obtner proveedores grabados
	$rsprov=$con->query("SELECT IDPROVEEDOR FROM $con->temporal.monitoreo_servicio_programado  WHERE TIPO='H-CERRAVIDRI' ORDER BY IDPROVEEDOR");
...
//caso contrario los iniciamos
	...
	echo "<table border='1' style='bborder:1px #333333 dashed;border-collapse:collapse'> 
		<tr bgcolor='#BCB9A7'>
			<td style='font-weight:bold;text-align:right' colspan='5'><input type='text' name='txtnombre' id='txtnombre' size='50' onFocus='coloronFocus(this);' onBlur='colorOffFocus(this);' class='classtexto' value='".$_GET['nombreprov']."' style='text-transform:uppercase' /><input type='button' name='btnbuscar' id='btnbuscar' value='Buscar' onclick='buscarProveedor()'/></td>
		</tr> 		
		<tr bgcolor='#BCB9A7'>
			<td style='width:7%'></td>
