		...
		<tr>
			<td width="50%" align="left" valign="top">
				<table border="1" width="100%" bordercolor="#000066" style="border-style:solid;border-collapse:collapse" cellspacing="0" cellpadding="2" align="center">
					...
					<td width="20%" align="center"><b><font color="white"><?=_('NRO');?></font></b><? if(validar_permisos("ASIGNAR_PROV_SERVPROG")){ ?><img src="../../../../imagenes/iconos/adds.gif" style="cursor:pointer" onclick="ventana_cambios(1)" width="9" height="11" title="<?=_('PRESENTACION');?>" alt="<?=_('PRESENTACION');?>"><? } ?></td>
				</tr>
						<?
							if($numreg >0)
							 {							
			...
			<td align="right" width="50%" valign="top">
				<table border="1" width="100%" bordercolor="#000066" style="border-style:solid;border-collapse:collapse" cellspacing="0" cellpadding="2" align="center">
					<tr bgcolor="#000066">
						...
						<td width="20%" align="center"><b><font color="white"><?=_('NRO');?></font></b><? if(validar_permisos("ASIGNAR_PROV_SERVPROG")){ ?><img src="../../../../imagenes/iconos/adds.gif" style="cursor:pointer" onclick="ventana_cambios(2)" width="9" height="11" title="<?=_('PRESENTACION');?>" alt="<?=_('PRESENTACION');?>"><? } ?></td>
					</tr>
				<?
						if($numvial >0)
						 {							
