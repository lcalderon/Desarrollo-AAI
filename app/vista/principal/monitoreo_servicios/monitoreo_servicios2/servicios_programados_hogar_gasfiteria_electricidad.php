...
/* 	$SQL_HOGAR="SELECT
				...
				WHERE ACTIVO =1 AND IDPROVEEDOR IN (6077,5527,5034,5820,5163,5968,5969,5866,5933,5960,5989,5223,5839,5289,6083)
				ORDER BY NOMBREFISCAL "; */
	...
	$sql_hogar="SELECT
				...
				WHERE catalogo_proveedor.ACTIVO = 1
					AND monitoreo_servicio_programado.TIPO = 'H-GASELE'
...
<body>
	<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
		<tr>
			...
			<td width="86%"><div align="center"><h1 style="color:#000066"><?=_('MONITOR SERVICIOS PROGRAMADOS HOGAR:GASFITERIA-ELECTRICIDAD');?></h1></div></td>
	...
	<table border="1" width="100%"   style="border:1px solid #000066;border-collapse:collapse" cellspacing="1" cellpadding="1">
		<tr bgcolor="#000066">
			<td colspan="4" bgcolor="#000066"><div align="center"><h2 style="color:#FFFFFF"><?=_('TECNICOS HOGAR');?></h2></div></td>
		</tr>
		<tr bgcolor="#000066">
			 ...
			 for ( $i = 1 ; $i <= 3 ; $i ++){
				...
				$sql_hogar_info="SELECT
						...
						$numinfo=$rs_info->num_rows*1;
						 ...
						 {		
							//$distriocomuna= ($nroubigeo ==3)?$row->distrito:$row->comuna;
							if($nroubigeo ==3){
							...
							$info[$i]=$info[$i]."<font color='#DD0000'>".$row->tiempo1."-".$row->tiempo2." / $distriocomuna</font><br>"."<font color='#002F5E'>".$row->idusuarioresponsable." - <a href='../../plantillas/etapa1_1.php?idasistencia=".$row->idasistencia."' target='_blank'>".$row->idasistencia."</a></font><br>";	
						 }
					}
				?>
	...
	<script type="text/javascript">	
		...
		function ventana_cambios(){
			...
			else
			{
				win = new Window({
					className: "alphacube",
					title: '<?=_("MODIFICAR PRESENTACION:GASFITERIA-ELECTRICIDAD")?>',
					width: 640,
					height: 420,
					...
					resizable: true,
					opacity: 0.95,
					url: 'paginar_hogar_gasfiteria_electricidad/'
				});
