...
//obtner proveedores grabados
	$rsprov=$con->query("SELECT IDPROVEEDOR FROM $con->temporal.monitoreo_servicio_programado WHERE TIPO='INSPECTOR'  ORDER BY IDPROVEEDOR");
...
//caso contrario los iniciamos
	...
	$SqlProveedor="SELECT
				...
				WHERE catalogo_servicio.IDFAMILIA = 1
					AND catalogo_proveedor.ACTIVO = 1
					AND catalogo_proveedor_servicio.IDSERVICIO = 111
...
//******--------determinar las páginas---------******//
	$SqlProv="SELECT
				...
				WHERE catalogo_servicio.IDFAMILIA = 1
					AND catalogo_proveedor.ACTIVO = 1
					AND catalogo_proveedor_servicio.IDSERVICIO = 3
					AND (catalogo_proveedor.NOMBRECOMERCIAL LIKE '%".$_GET['nombreprov']."%'
					OR catalogo_proveedor.NOMBREFISCAL LIKE '%".$_GET['nombreprov']."%')
