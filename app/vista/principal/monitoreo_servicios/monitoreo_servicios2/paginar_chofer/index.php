...
<head>
	...
	//paginar segun el numero de la pagina
		function paginar(nropagina){
		
			new Ajax.Updater('contenido', 'paginador.php', {
				parameters: { pag: nropagina, nombreusu: $F('txtnombre') },
				method: 'get',
	...
	//buscar al coodinador por nombre o apellido
	...
	//grabar coordinador segun el ckeck
