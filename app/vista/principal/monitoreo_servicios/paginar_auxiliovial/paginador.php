...
//obtner proveedores grabados
	$rsprov=$con->query("SELECT IDPROVEEDOR FROM $con->temporal.monitoreo_servicio_programado  WHERE TIPO='AUXILIOV' ORDER BY IDPROVEEDOR");
...
//caso contrario los iniciamos
	...
	$SqlProveedor="SELECT
				...
				WHERE catalogo_servicio.IDFAMILIA = 1
					...
					AND catalogo_proveedor_servicio.IDSERVICIO = 8
