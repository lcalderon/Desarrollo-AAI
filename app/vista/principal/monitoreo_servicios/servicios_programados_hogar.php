...
/* 	$SQL_HOGAR="SELECT
	...
	$sql_hogar="SELECT
				...
				WHERE catalogo_proveedor.ACTIVO = 1
					AND monitoreo_servicio_programado.TIPO = 'HOGAR'
...
<body>
	<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
		<tr>
			...
			<td width="86%"><div align="center"><h1 style="color:#000066"><?=_('MONITOR SERVICIOS PROGRAMADOS - HOGAR VARIOS');?></h1></div></td>
	...
	<table border="1" width="100%"   style="border:1px solid #000066;border-collapse:collapse" cellspacing="1" cellpadding="1">
		<tr bgcolor="#000066">
			<td colspan="4" bgcolor="#000066"><div align="center"><h2 style="color:#FFFFFF"><?=_('TECNICOS HOGAR VARIOS');?></h2></div></td>
		</tr>
		<tr bgcolor="#000066">
