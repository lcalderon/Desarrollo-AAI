...
//cantidad de ubigeo
	...
	$sql_hogar="SELECT
				...
				WHERE catalogo_proveedor.ACTIVO = 1
					AND monitoreo_servicio_programado.TIPO = 'H-CERRAVIDRI'
...
<html>
	<head>
		<title><?=_('Monitoreo Hogar : Cerrajeria-Vidrieria');?></title>
...
<body>
	<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
		<tr>
			...
			<td width="86%"><div align="center"><h1 style="color:#000066"><?=_('MONITOR SERVICIOS PROGRAMADOS HOGAR:CERRAJERIA-VIDRIERIA');?></h1></div></td>
	...
	<script type="text/javascript">	
		...
		function ventana_cambios(){
			...
			else
			{
				win = new Window({
					className: "alphacube",
					title: '<?=_("MODIFICAR PRESENTACION:CERRAJERIA-VIDRIERIA")?>',
					width: 640,
					height: 420,
					...
					resizable: true,
					opacity: 0.95,
					url: 'paginar_hogar_cerrajeria_vidrieria/'
				});
