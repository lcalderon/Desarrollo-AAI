...
//obtner proveedores grabados
	$rsprov=$con->query("SELECT IDPROVEEDOR FROM $con->temporal.monitoreo_servicio_programado WHERE TIPO='MEDICODOM'  ORDER BY IDPROVEEDOR");
...
//caso contrario los iniciamos
	...
	$SqlProveedor="SELECT
				...
				WHERE catalogo_servicio.IDFAMILIA = 4
					...
					AND catalogo_proveedor_servicio.IDSERVICIO = 19
