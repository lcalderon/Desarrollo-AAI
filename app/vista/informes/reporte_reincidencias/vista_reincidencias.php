...
?>
		...
		<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFE8" style="border:1px dashed #CC3366">          
			...
			<tr>
				<td><input name="chkopcion5[]" type="checkbox" id="chkserviciopor" value="DEPARTAMENTO" <?=($opcions["DEPARTAMENTO"])?"checked":"" ;?>  /><?=_("ENTIDAD 1") ;?></td>
				<td><input name="chkopcion5[]" type="checkbox" id="chktiposerv3" value="PROVINCIA" <?=($opcions["PROVINCIA"])?"checked":"" ;?>  /><?=_("ENTIDAD 2") ;?></td>
				<td><input name="chkopcion5[]" type="checkbox" id="chktiposerv4" value="DISTRITO" <?=($opcions["DISTRITO"])?"checked":"" ;?>  /><?=_("ENTIDAD 3") ;?></td>
			...
			<tr>
				...
				<td colspan="5"><input name="chkopcion5[]" type="checkbox" id="chkasigdiferida" value="ASIG_DIFERIDA" <?=($opcions["ASIG_DIFERIDA"])?"checked":"" ;?> title="Asignaci&oacute;n Diferida" /><?=_("ASIG. DIFERIDA") ;?></td>
			</tr>			
        </table>		
        ...
        <table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFE8" style="border:1px dashed #CC3366">        
            ...
            <tr>
                ...
                <td><input name="chkopcion6[]" type="checkbox" id="chkopciones20" value="COORDINADOR" <?=($opcions["COORDINADOR"])?"checked":"" ;?>/><?=_("COORDINADOR") ;?></td>
            ...
            <tr>
				...
				<td colspan="4"><input name="chkopcion6[]" type="checkbox" id="chketapa" value="NUMERO_ETAPA" title="N&uacute;mero de etapa" <?=($opcions["NUMERO_ETAPA"])?"checked":"" ;?>/><?=_("NUMERO ETAPA") ;?></td>
			</tr>
        </table>
        ...
        <table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFF4F4" style="border:1px dashed #CC3366">
			...
			<tr>
				...
				<td><input name="chkopcion1[]" type="checkbox" id="chkopciones14" value="TIEMPO_TOTAL" <?=($opcions["TIEMPO_TOTAL"])?"checked":"" ;?> /><?=_("Tiempo_total") ;?></td>
				<td><input name="chkopcion1[]" type="checkbox" id="chkopciones15" value="TIEMPO_TOTAL" <?=($opcions["TIEMPO_TOTAL"])?"checked":"" ;?> /><?=_("Tiempo_total") ;?></td>
			</tr>			
			<tr>
        ...
        <table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFF4F4" style="border:1px dashed #CC3366">
			...
			<tr>           
				<td><input name="chkopccalidad[]" type="checkbox" id="chkopciones33" value="STATUSCALIFICAEXP" <?=($opcions["SUPERVISOR"])?"checked":"" ;?> /><?=_("STATUS EXPEDIENTE") ;?></td>
				<td><input name="chkopccalidad[]" type="checkbox" id="chkopciones34" value="USUARIOCALIFICA" <?=($opcions["SUPERVISOR"])?"checked":"" ;?>  /><?=_("USUARIO CALIFCA EXP.") ;?></td>
				<td><input name="chkopccalidad[]" type="checkbox" id="chkopciones35" value="STATUSAUDITORIA" <?=($opcions["SUPERVISOR"])?"checked":"" ;?>  /><?=_("STATUS AUDITORIA") ;?></td>
			</tr>
        </table>