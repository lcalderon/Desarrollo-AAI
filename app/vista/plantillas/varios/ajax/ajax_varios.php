...
/* DATOS PARA LA TABLA VARIOS */
$varios[IDASISTENCIA]= $idasistencia;
$varios[IDCONTACTANTE]= $_POST[IDCONTACTANTE];
$varios[IDSERVICIO]=$_POST[IDSERVICIO];
$varios[IDLUGAR]=$_POST[IDLUGAR];
$varios[LUGARDELEVENTO]=$_POST[LUGARDELEVENTO];
$varios[IDUSUARIOMOD]=$_POST[IDUSUARIO];

if ($_POST[IDASISTENCIA]=='')
{
	$con->insert_reg($con->temporal.'.asistencia_varios',$varios);
}
else {
	$con->update($con->temporal.'.asistencia_varios',$varios," where IDASISTENCIA = '$_POST[IDASISTENCIA]'  ");
