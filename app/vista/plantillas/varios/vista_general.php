...
function validar_datos_generales(){
	...
	var sw=false;
	if ($F('lugardelevento')=='') alert("<?=_('INGRESE LA UBICACION DEL EVENTO')?>");
	else sw = true;
	return sw ;
}
