...
/* DATOS PARA LA TABLA MASCOTA */
$mascota[IDASISTENCIA]= $idasistencia;
$mascota[IDCONTACTANTE]= $_POST[IDCONTACTANTE];
$mascota[IDLUGARDELEVENTO]=$_POST[IDLUGARDELEVENTO];
$mascota[IDSERVICIO]=$_POST[IDSERVICIO];
$mascota[ARRTIPOINMUEBLE]=$_POST[ARRTIPOINMUEBLE];
$mascota[ARRPRIORIDADATENCION]=$_POST[ARRPRIORIDADATENCION];
$mascota[NOMBREMASCOTA]=$_POST[NOMBREMASCOTA];
$mascota[EDADMASCOTA]=$_POST[EDADMASCOTA];
$mascota[RAZA]=$_POST[RAZA];
$mascota[COLOR]=$_POST[COLOR];
$mascota[PEDIGREE]=$_POST[PEDIGREE];
$mascota[IDUSUARIOMOD]=$_POST[IDUSUARIO];

if ($_POST[IDASISTENCIA]=='')
{
	$con->insert_reg($con->temporal.'.asistencia_mascota',$mascota);
}
else {
	$con->update($con->temporal.'.asistencia_mascota',$mascota," where IDASISTENCIA = '$_POST[IDASISTENCIA]'  ");
