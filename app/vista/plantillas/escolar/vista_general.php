...
<div id='datos_generales_plantilla' style="float:left; weight:48%" align="left">
 <form name='form_datos_generales' id='form_datos_generales'  >
	...
	<input type="hidden" name="dateactual" id="dateactual" value="<?=date("Y-m-d");?>" /> 
	...
	<table>
		...
		<tr>
			...
			<td><? $con->cmbselect_ar('CMBTIPOATENCIONESC',$tipoatencion_escolar,$asis->asistencia_familia->ARRTIPOATENCIONESCOLAR,'','','') ?></td>
		</tr>		
