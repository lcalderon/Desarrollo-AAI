...
if ($con->exist($con->temporal.'.asistencia_pc_visitatecnica','IDASISTENCIA'," where IDASISTENCIA = '$_GET[idasistencia]'"))
{
	$con->update($con->temporal.'.asistencia_pc_visitatecnica',$reg," WHERE IDASISTENCIA ='$_GET[idasistencia]'");	
}
else 
{
	$con->insert_reg($con->temporal.'.asistencia_pc_visitatecnica',$reg);	
}
