...
<legend><?=_('ORIENTACION TELEFONICA')?></legend>

<form id='form_orientaciontelefonica'>
...
<table>
	...
	<tbody>
		...
		<?	$con->cmbselect_ar('ARRTIPOCONSULTA',$referencia,(isset($asis))?$asis->asistencia_servicio->TIPOCONSULTA:$tipoconsulta,'id=arrtipoconsulta','onclick=mostrar_subservicio(this,"subreferencia","subreferencia_taller")','')?></td>
