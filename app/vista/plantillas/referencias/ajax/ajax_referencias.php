...
/* DATOS PARA LA TABLA REFERENCIAS */
$ref[IDASISTENCIA]= $idasistencia;
$ref[IDCONTACTANTE]= $_POST[IDCONTACTANTE];
$ref[IDSERVICIO]=$_POST[IDSERVICIO];
$ref[IDLUGAR]=$_POST[IDLUGAR];
$ref[LUGARDELEVENTO]=$_POST[LUGARDELEVENTO];
$ref[IDUSUARIOMOD]=$_POST[IDUSUARIO];


if ($_POST[IDASISTENCIA]=='')
{
	$con->insert_reg($con->temporal.'.asistencia_referencias',$ref);
}
else {
	$con->update($con->temporal.'.asistencia_referencias',$ref," where IDASISTENCIA = '$_POST[IDASISTENCIA]'  ");
