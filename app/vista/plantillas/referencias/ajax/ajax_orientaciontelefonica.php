...
if ($con->exist($con->temporal.'.asistencia_referencias_orientaciontelefonica','IDASISTENCIA'," where IDASISTENCIA = '$_GET[idasistencia]'"))
{
	$con->update($con->temporal.'.asistencia_referencias_orientaciontelefonica',$reg," WHERE IDASISTENCIA ='$_GET[idasistencia]'");	
}
else 
{
	$con->insert_reg($con->temporal.'.asistencia_referencias_orientaciontelefonica',$reg);	
}
