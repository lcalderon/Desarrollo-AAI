...
$viajes[IDASISTENCIA]= $idasistencia;
$viajes[IDCONTACTANTE]= $_POST[IDCONTACTANTE];
$viajes[IDSERVICIO]=$_POST[IDSERVICIO];
$viajes[IDLUGARDELEVENTO]=$_POST[IDLUGARDELEVENTO];
$viajes[IDUSUARIOMOD]=$_POST[IDUSUARIO];

if ($_POST[IDASISTENCIA]=='')
{
	$con->insert_reg($con->temporal.'.asistencia_viajes',$viajes);
}
else {
	$con->update($con->temporal.'.asistencia_viajes',$viajes," where IDASISTENCIA = '$_POST[IDASISTENCIA]'  ");
