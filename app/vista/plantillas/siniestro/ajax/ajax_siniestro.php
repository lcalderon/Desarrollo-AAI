...
/* DATOS PARA LA TABLA SINIESTRO */
$siniestro[IDASISTENCIA]= $idasistencia;
$siniestro[IDCONTACTANTE]= $_POST[IDCONTACTANTE];
$siniestro[IDSERVICIO]=$_POST[IDSERVICIO];
$siniestro[IDLUGARDELEVENTO]=$_POST[IDLUGARDELEVENTO];
//$siniestro[ARRPRIORIDADATENCION]=$_POST[ARRPRIORIDADATENCION];
$siniestro[ARRTIPOSINIESTRO]=$_POST[ARRTIPOSINIESTRO];
$siniestro[IDUSUARIOMOD]=$_POST[IDUSUARIO];

if ($_POST[IDASISTENCIA]=='')
{
	$con->insert_reg($con->temporal.'.asistencia_siniestro',$siniestro);
}
else {
	$con->update($con->temporal.'.asistencia_siniestro',$siniestro," where IDASISTENCIA = '$_POST[IDASISTENCIA]'  ");
